...
module RetailApi
  class Application < Rails::Application
    ...
    config.active_record.schema_migrations_table_name = "retail_api.schema_migrations"
    config.active_record.internal_metadata_table_name = "retail_api.ar_internal_metadata"
